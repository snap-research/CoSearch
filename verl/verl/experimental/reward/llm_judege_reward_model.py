...
class LLMJudgeRewardModelManager:
    ...
    def _initialize_llm_servers(self):
        ...
        # Convert raw OmegaConf to RolloutConfig dataclass so that _target_ is present
        # (required by omega_conf_to_dataclass inside the replica constructor)
