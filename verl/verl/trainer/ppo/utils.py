...
class Role(Enum):
    ...
    def _get_role_string(self):
        role_mapping = {
            ...
            Role.RerankerRollout: "reranker_rollout",
            Role.RerankerActorRollout: "reranker_actor_rollout",
            Role.RerankerRefPolicy: "reranker_ref",
        }
    ...
    def from_string(cls, name: str):
        string_mapping = {
            ...
            "reranker_rollout": cls.RerankerRollout,
            "reranker_actor_rollout": cls.RerankerActorRollout,
            "reranker_ref": cls.RerankerRefPolicy,
        }
